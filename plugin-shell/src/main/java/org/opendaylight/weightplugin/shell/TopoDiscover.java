...
import org.opendaylight.weightplugin.IKarafCore;
import org.opendaylight.controller.sal.utils.ServiceHelper;

@Command(scope = "weightplugin", name = "TopoDiscover", description="Topology Discovery (collect topology among switches)")
