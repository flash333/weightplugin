...
import org.opendaylight.weightplugin.IKarafVLANService;
import org.opendaylight.controller.sal.utils.ServiceHelper;

@Command(scope = "weightplugin", name = "AddVlanSetPorts", description="Add VLAN and set the VLAN ports on the switch")
