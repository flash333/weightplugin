...
import org.opendaylight.weightplugin.core.ISwitchStateListener;
import org.opendaylight.controller.sal.core.Node;
import org.opendaylight.controller.sal.core.NodeConnector;
import org.opendaylight.weightplugin.internal.ConfigService;
import org.opendaylight.weightplugin.internal.SNMPHandler;
import org.opendaylight.weightplugin.internal.SNMPListener;
import org.opendaylight.weightplugin.internal.util.CmethUtil;
import org.opendaylight.weightplugin.protocol.SNMPMessage;
import org.opendaylight.weightplugin.protocol.SNMPType;
import org.opendaylight.weightplugin.protocol.SNMPPhysicalPort;
import org.opendaylight.weightplugin.protocol.SNMPPortStatus;
import org.opendaylight.weightplugin.protocol.SNMPPortStatus.SNMPPortReason;
...
public class Controller implements IController, IKarafCore, CommandProvider {
     ...
     */
    public void init() {
        logger.info("weightplugin's Controller: Initializing!");
     ...
     */
    public void start() {
        logger.info("weightplugin's Controller: Starting!");
        /*
    ...
    private void handleAddingSwitchAndItsPorts(Long sid){
        ...
        while(this.switches.get(sid) == null){
            logger.trace("weightplugin-controller.handleAddingSwitch({}) not yet done", sid);
            try{
                Thread.sleep(500);
            }catch(Exception e){;}
        }
        logger.trace("weightplugin-controller.handleAddingSwitch({}) is done", sid);
        scanAndAddPort(sid);
    }
