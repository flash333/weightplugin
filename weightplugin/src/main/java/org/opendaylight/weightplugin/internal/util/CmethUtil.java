...
package org.opendaylight.weightplugin.internal.util;
...
public class CmethUtil implements CommandProvider{
    ...
    public CmethUtil(){
        ...
        if(isDBPathFixed)
            readDB("/home/christine/weightplugin/weightplugin/src/test/switch_login_db.csv");
    }
    ...
    public void readDB(String dbPath){
        ...
        try{
        logger.info("open file " + dbPath);//  "/home/christine/weightplugin/weightplugin/src/test/switch_login_db.csv"
        FileReader FileStream=new FileReader(dbPath); //"/home/christine/weightplugin/weightplugin/src/test/switch_login_db.csv"
