...
public class SNMPMessage implements Serializable{
    ...
    protected int xid;
    protected Long targetSwitchID;//s4s add. In OF, socket to switch always there, but in weightplugin, we need to bring the switch ID in SNMPMessage, so that finally give snmp the switch mac address.
